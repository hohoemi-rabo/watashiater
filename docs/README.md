...
**29〜34 がクローズドテストの声への修正**（2026-09-08 のヒアリングで内容確定）、**36・37 が実機確認中に出た追加の修正**、**35 が製品版申請**。**36・37 は 35 より先に入れる**（2026-09-12 ユーザー判断。37 のアイコンは 35 で作る production ビルドに載せる）。
...
| 37 | [アプリアイコン：「山に見える」を直す](./37-icon-not-a-mountain.md) | テストの声への修正 |
